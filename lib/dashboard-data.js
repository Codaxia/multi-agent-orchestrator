...
const DEFAULT_WORKSPACE = {
  squads: [
    ...
    },
    {
      ...
      projects: [
        {
          id: 'pme-dashboard-setup-layout',
          label: 'Tableau de bord PME — Setup projet et layout dashboard',
          description: 'Création du projet Tableau de bord PME (structure HTML, sidebar, topbar, zones KPI et charts) — mission historique terminée.',
        },
        {
          id: 'pme-dashboard-csv-import',
          label: 'Tableau de bord PME — Import CSV et calcul des KPI',
          description: 'Parser CSV des ventes + calcul automatique des KPI (CA, marge, ticket moyen, top client) avec affichage live — mission historique terminée.',
        },
        {
          id: 'pme-dashboard-charts',
          label: 'Tableau de bord PME — Graphiques revenus et top clients',
          description: 'Intégration de Chart.js : courbe des revenus par mois, bar chart top clients, donut répartition des dépenses — mission historique terminée.',
        },
      ],
    },
    {
